    ...
    <div class="collapse navbar-collapse mynavbar" id="navbarNavDropdown">
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active nav-color" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            Mahasiswa
          </a>
        ...
        <!-- Jadwal Kuliah -->
        <li class="nav-item">
          <a class="nav-link active nav-color" aria-current="page" href="selectAdminJadwal.php">Jadwal Kuliah</a>
        </li>
        <!-- Logout -->
        <li class="nav-item">
