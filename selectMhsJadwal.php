<?php
  ...
  function search() {
    ?>
    <form class="search-box-body" action="searchMhsJadwal.php" method="POST">
...
<html lang="en">
  <head>
    ...
    <title>Data Jadwal Kuliah - Bagus Nata</title>
  </head>
          ...
          ?>
            <tbody class="table-body">
              <tr>
                ...
                <!-- tampilkan jadwal -->
                <td class="text-center"> 
                  <a style="color:black;" href="tampilkanMhsJadwal.php?nim=<?php echo $tampil['nim']?>" class="btn-edit"> <img src="Assets/Image/b_document.png" width="30px"> Tampilkan </a>
                </td>
                <!-- pilih jadwal -->
                <td class="text-center"> 
                  <a style="color:black;" href="insertMhsJadwal.php?nim=<?php echo $tampil['nim']?>" class="btn-edit"> <img src="Assets/Image/b_choose.png" width="30px"> Pilih </a>
                </td>
              </tr>
              <?php } ?>
            </tbody>
